...
const Footer = () => {
  return (
   ...
   <Image src={mobileLogo} alt="image" className=" w-20"></Image>
      ...
      <div className="flex flex-col font-mono lg:flex-row md:gap-96 px-[2.2rem] items-start">
        {/* Logo Section */}
      ...
      <div className="mt-10 px-8 text-[.75rem] font-mono text-left">
        <p>Copyright © 2024 Aegean Operations LP All rights reserved.
          “Aegean” is a trademark, and the Traingular mobius symbol to be changed to 
          custom red AI symbol
        </p>
      </div>
    </footer>
  );
