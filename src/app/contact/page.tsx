...
const Contact = () => {
    return (
        ...
        <div className="flex  flex-col lg:flex-row items-start lg:items-start h-auto lg:h-screen p-6 lg:p-10 pt-20">
            ...
            <div className="text-left text-black/20 font-serif text-xl lg:text-4xl lg:pr-56 mb-10 lg:mb-0">
                Contact
            </div>
            ...
            <div className="space-y-5 w-full lg:w-auto">
                ...
                <div className="text-black">
                    ...
                    <div className="text-lg lg:text-4xl py-2 font-serif">info@Aegean.xyz</div>
                </div>

                {/* Press Inquiries Section */}
                <div className="text-black">
                    <div className="text-xs lg:text-sm uppercase font-mono">Press Inquiries</div>
                    <div className="text-lg lg:text-4xl py-2 font-serif">press@Aegean.xyz</div>
                </div>

                {/* Investor Inquiries Section */}
                <div className="text-black">
                    <div className="text-xs lg:text-sm uppercase font-mono">Investor Inquiries</div>
                    <div className="text-lg lg:text-4xl py-2 font-serif">inv_inquiries@Aegean.xyz</div>
                </div>
                ...
                <div className="">
                    ...
                    <div className="flex flex-wrap space-x-2 lg:space-x-4 pt-2 text-[.65rem]">
