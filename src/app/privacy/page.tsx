      ...
      <div className="bg-white pt-12">
        <div className="flex justify-center items-start flex-col mx-auto max-w-3xl h-full p-10 mb-20 space-y-6">
          ...
          <p className="text-black font-serif leading-relaxed">
            ...
            information about Paradigm Operations LP (together with its
            affiliates, “Paradigm,” “we,” “our,” or “us”), its services to
            ...
            Paradigm. Paradigm does not intend to solicit or make its investment
            ...
            Paradigm nor should it be construed as an offer to provide
            ...
            individual quoted therein and are not the views of Paradigm. Any
            ...
            managed by Paradigm and there can be no assurance that the
